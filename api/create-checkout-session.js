...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      custom_text: {
        submit: {
          message: 'You pay $0.99 today and your 3-day Premium trial starts immediately.'
        },
        terms_of_service_acceptance: {
          message: 'By continuing, you agree to the applicable Premium subscription terms.'
        }
      },
      metadata: {
        dealcheck_user_id: userId,
